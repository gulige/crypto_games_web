...
var LocaleUtils = (function (_super) {
    __extends(LocaleUtils, _super);
    function LocaleUtils() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    LocaleUtils.getLabelById = function (locale, id) {
        var label = this.items[locale][id];
        console.log(label);
        return label;
    };
    LocaleUtils.getLabelByIdAndValue = function (locale, id, array) {
        var label = this.items[locale][id];
...
__reflect(LocaleUtils.prototype, "LocaleUtils");
